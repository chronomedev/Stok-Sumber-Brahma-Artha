...
namespace sistem_stok_ayam
{
    class kelasDatabase
    {
        ...
        public DataTable ambilData_list_Transaksi()
        {
            ...
            String querySQL = "select Ms_Pergerakan_Barang.tanggal, Ms_pergerakan_Barang.kode_barang, Ms_Barang.nama_barang, Ms_Pergerakan_Barang.pergerakan_barang, Ms_Customer.nama_customer, Ms_Pergerakan_Barang.uang_masuk, Ms_Pergerakan_Barang.cogs from Ms_Pergerakan_Barang LEFT JOIN Ms_Barang on Ms_Barang.kode_barang = Ms_Pergerakan_barang.kode_barang LEFT JOIN Ms_Customer on Ms_Pergerakan_Barang.kode_customer = Ms_Customer.kode_customer; ";
